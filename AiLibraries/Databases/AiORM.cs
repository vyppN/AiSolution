...
namespace AiLibraries.Databases
{
    ...
    public abstract class AiORM
    {
        ...
        {
            get { return "Data not exists in database"; }
        }
        ...
        protected void SetTableNameExplicit(string TableName)
        {
            _query.SetTableName(TableName);
        }
