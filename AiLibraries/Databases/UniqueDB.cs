...
{
    /// <summary>
    /// เชื่อมต่อ Database แบบ Singleton
    /// </summary>
...
// ReSharper restore InconsistentNaming
        ...
        /// <summary>
        /// ต่อ Database จาก config file
        /// [ไฟล์ถูกเข้ารหัสด้วย Rijndael Algorithm]
        /// </summary>
        /// <param name="path">ที่อยู่ไฟล์</param>
        /// <param name="key">key ถอดรหัสไฟล์</param>
        /// <param name="port"></param>
        /// <param name="utf8"></param>
        /// <returns></returns>
